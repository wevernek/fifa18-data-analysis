---
title: "Case de Advanced Analytics cb"
...
selecionando os goleiros da variável `fifa18` e criando a variável `fifa.18.cb_europe`
```{r}
...
```
selecionando os goleiros da variável `fifa18` e criando a variável `fifa.18.cb_nao_europe`
```{r}
fifa.18.cb_nao_europe <- fifa18 %>%
  filter(positioning == "59" & continente != "Europe" )

unique(fifa.18.cb_nao_europe$continente)
head(fifa.18.cb_nao_europe)
```
...
fifa.18.cb_final$positioning <- gsub('14', 'cb', fifa.18.cb_final$positioning)
