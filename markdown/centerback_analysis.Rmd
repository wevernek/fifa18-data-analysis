...
## Filtrando Zagueiros
Ainda na análise, filtramos os zaqueiros dos times
```{r}
CENTER_EUROPE <- df %>%
...
head(CENTER_EUROPE)
```
Então, selecionamos os zagueiros da variável
```{r}
#-- base para validacao
...
Resultado final com os zagueiros centrais e seus valores preditos
