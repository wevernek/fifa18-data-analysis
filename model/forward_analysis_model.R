...
# Conseguimos identificar uma grande concentração de jogadores com overall entre 62 e 72
...
# Boxplot dos valores de 'FORWARD_EUROPE' ... Outliers no valor em euros
boxplot(FORWARD_EUROPE)

# Matriz de correlação das habilidades e características dos jogadores selecionados em FORWARD_EUROPE
...
reg <- tree(data = FORWARD_EUROPE, formula = eur_value ~ .)
plot(reg)
text(reg)
summary(reg)
...
# Seleciona as variáveis 'Position', 'name', e 'eur_value' de FORWARD_NOT_EUROPE e atribui
